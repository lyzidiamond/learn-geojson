...
6. Add some points. Add some attributes for those points. Add as many or as few as you want!
7. When you're done adding points, click Save on the top bar. A small box appears asking for a "Commit message." Type in a short description of the points you added and press Commit.
